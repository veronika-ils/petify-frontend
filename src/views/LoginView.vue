      ...
      <div class="card-body p-4 p-md-5">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
          ...
          <div class="flex-grow-1">
            <h1 class="h4 mb-1 title">Welcome back</h1>
            <p class="text-muted mb-0">Log in to manage your Petify account.</p>
          </div>
        </div>
        ...
        <div class="d-flex justify-content-between mt-4">
          ...
          <RouterLink class="link accent" to="/signup">Create account</RouterLink>
        </div>
      </div>
    </div>

    <p class="text-center mt-3 small text-muted mb-0">
      By logging in you agree to treat pets with kindness 🧡
    </p>
  </main>
</template>
...
async function submit() {
  ...
  loading.value = true
  try {
    // If you want to actually persist "remember me", hook this into your auth store
    // (e.g., store token in localStorage vs sessionStorage).
...
/* Fix rounding for group with eye button */
.auth-input .input-group-text {
  border-right: 0;
}
.auth-input .form-control {
